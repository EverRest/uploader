ghfdhfghfdf<?php defined('ROOT_PATH') or exit('No direct script access allowed');

	$config['base_url'] = 'http://sviymarket.com';
	...
	*/
	...
	|
	*/
	$config['encryption_key'] = '^jFV~0a@eNLc';
	...
	*/
	...
	/*
	|--------------------------------------------------------------------------
	| SEGMENTS OF THE URL THAT NEED TO BE CLEANED
	|--------------------------------------------------------------------------
	*/
